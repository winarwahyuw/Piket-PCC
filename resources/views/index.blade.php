...
<div class="container">
    ...
    <!-- Start Modal -->
    <div class="modal fade" id="modal-tambah-piket" data-backdrop="static" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ url('store')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="datetime" name="mulai_piket" id="mulai_piket"
                                value="{{ gmdate('H:i:s', (time() + (60 * 60 * 7)))}}" disabled>
                        </div>
        ...
        <table class="table table-striped table-hover table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if( time() >= strtotime(date('H:i:s', strtotime($list_piket->mulai_piket)+ 2*60*60)))
                        <a href="{{ url('edit/' .$list_piket->id_piket. '/editData')}}" class="btn btn-warning"
                            type="button" value="Selesai">Selesai</a>
                        @else
                        Selesaikan piket
                        @endif
                    </td>
